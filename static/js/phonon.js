...
(function (global, factory) {
  ...
  function boot() {
    ...
    if (document.body) {
      ...
      var obs_1 = new MutationObserver((() => {
        if (document.body) {
          obs_1.disconnect();
          observe();
        }
  ...
  const Component = (function () {
    function Component(name, defaultProps, props) {
      ...
      let config = {};
      if (element) {
        const dataConfig = utils.Selector.attrConfig(element);
        if (dataConfig) {
          config = dataConfig;
        }
      }
      this.defaultProps = defaultProps;
      this.props = Object.assign(defaultProps, config, props, { element });
      this.id = this.uid();
    ...
    Component.prototype.registerElements = function (elements) {
      const _this = this;
      elements.forEach(element => _this.registerElement(element));
    };
  ...
  const Collapse = (function (_super) {
    __extends(Collapse, _super);
    function Collapse(props) {
      if (props === void 0) { props = { toggle: false }; }
      const _this = _super.call(this, 'collapse', { toggle: false }, props) || this;
      const toggle = _this.getProp('toggle');
      if (toggle) {
        _this.toggle();
      }
      return _this;
    ...
    Collapse.attachDOM = function () {
      ...
      document.addEventListener(utils.Event.CLICK, (event) => {
        if (!event.target) {
          return;
        }
        const target = utils.Selector.closest(event.target, '[data-toggle]');
        if (!target) {
          return;
        }
        ...
        if (dataToggleAttr && dataToggleAttr === className) {
          ...
          const collapseComponent = utils.Observer.getComponent(className, { element: collapse });
  ...
  const Accordion = (function (_super) {
    __extends(Accordion, _super);
    function Accordion(props) {
      const _this = _super.call(this, 'accordion', { multiple: false }, props) || this;
      _this.collapses = [];
      const element = _this.getElement();
      const toggles = Array
        .from(element.querySelectorAll('[data-toggle="accordion"]') || []);
      toggles.forEach((toggle) => {
        const collapseId = toggle.getAttribute('href') || toggle.getAttribute('data-target');
        if (collapseId === null) {
    ...
    Accordion.prototype.onElementEvent = function (event) {
      const { target } = event;
      const toggleEl = utils.Selector.closest(target, '[data-toggle="accordion"]');
      if (!toggleEl) {
        return;
      }
      ...
      const accordion = utils.Selector.closest(toggleEl, '.accordion');
  ...
  const Alert = (function (_super) {
    __extends(Alert, _super);
    function Alert(props) {
      if (props === void 0) { props = { fade: true }; }
      const _this = _super.call(this, 'alert', { fade: true }, props) || this;
      _this.onTransition = false;
      if (_this.getOpacity() !== 0) {
        const target = _this.getElement().querySelector('[data-dismiss="alert"]');
        if (target) {
          _this.registerElement({ target, event: utils.Event.CLICK });
        }
      }
      return _this;
    }
    ...
    Alert.prototype.show = function () {
      ...
      var onShow = function () {
        ...
        const target = utils.Selector.closest(_this.getElement(), '[data-dismiss="alert"]');
        if (target) {
          _this.registerElement({ target, event: utils.Event.CLICK });
        }
  ...
  const Modal = (function (_super) {
    ...
    function Modal(props, autoCreate) {
      ...
      const _this = _super.call(this, 'modal', {
        title: null,
        message: null,
        cancelable: true,
        background: null,
    ...
    Modal.attachDOM = function () {
      ...
      document.addEventListener(utils.Event.CLICK, (event) => {
        ...
        const toggleEl = utils.Selector.closest(target, `[data-toggle="${className}"]`);
        if (toggleEl) {
          ...
          const modalComponent = utils.Observer.getComponent(className, { element: modal });
          if (!modalComponent) {
            return;
          }
          target.blur();
    ...
    Modal.prototype.onElementEvent = function (event) {
      ...
      if (event.type === utils.Event.CLICK) {
        ...
        const dismissButton = utils.Selector.closest(target, '[data-dismiss]');
    ...
    Modal.prototype.center = function () {
      ...
      if (computedStyle && computedStyle.height) {
        ...
        const top_1 = (window.innerHeight / 2) - (parseFloat(height) / 2);
    ...
    Modal.prototype.attachEvents = function () {
      ...
      buttons.forEach(button => _this.registerElement({
        target: button,
    ...
    Modal.prototype.detachEvents = function () {
      ...
      const buttons = Array
        .from(element.querySelectorAll('[data-dismiss], .modal-footer button') || []);
      buttons.forEach(button => _this.unregisterElement({
        target: button,
        event: utils.Event.CLICK,
      }));
      const cancelable = this.getProp('cancelable');
  ...
  const ModalConfirm = (function (_super) {
    __extends(ModalConfirm, _super);
    function ModalConfirm(props) {
      const _this = _super.call(this, Object.assign({
        buttons: [
          {
  ...
  const ModalLoader = (function (_super) {
  ...
  const ModalPrompt = (function (_super) {
  ...
  const Notification = (function (_super) {
    ...
    function Notification(props) {
      ...
      const _this = _super.call(this, 'notification', {
        button: true,
        timeout: null,
        title: '',
        message: null,
    ...
    Notification.prototype.setPosition = function () {
      ...
      activeNotifications.forEach((n) => {
        if (notification !== n) {
          ...
          const top_1 = parseInt(style.marginTop, 10);
  ...
  const OffCanvas = (function (_super) {
    __extends(OffCanvas, _super);
    function OffCanvas(props) {
      const _this = _super.call(this, 'off-canvas', {
        toggle: false,
        closableKeyCodes: [27],
      ...
      window.addEventListener('resize', () => _this.checkWidth(), false);
      return _this;
    }
    OffCanvas.attachDOM = function () {
      ...
      document.addEventListener(utils.Event.CLICK, (event) => {
        ...
        if (toggleEl) {
          ...
          const offCanvasComponent = utils.Observer.getComponent(className, { element: offCanvas });
    ...
    OffCanvas.prototype.show = function () {
      ...
      (function () {
        return __awaiter(_this, void 0, void 0, function () {
          let onShown; let container; let containerShowClass; let
            el;
          const _this = this;
          return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    OffCanvas.prototype.hide = function () {
      ...
      if (!this.showAside) {
        const backdrop_1 = this.getBackdrop();
        if (!backdrop_1) {
          return true;
        }
    ...
    OffCanvas.prototype.attachEvents = function () {
      ...
      Array.from(element.querySelectorAll('[data-dismiss]') || [])
        .forEach(button => _this.registerElement({
          target: button,
          event: utils.Event.CLICK,
        }));
      const backdrop = this.getBackdrop();
    ...
    OffCanvas.prototype.detachEvents = function () {
      ...
      if (dismissButtons) {
        Array
          .from(dismissButtons)
          .forEach(button => _this.unregisterElement({
            target: button,
            event: utils.Event.CLICK,
          }));
      }
  ...
  const Progress = (function (_super) {
    ...
    function Progress(props) {
      const _this = _super.call(this, 'progress', {
        height: 8,
        min: 0,
        max: 100,
        now: 0,
    ...
    Progress.prototype.set = function (value) {
      ...
      const progress = Math.round((value / (min + max)) * 100);
      if (value < min) {
  ...
  const Selectbox = (function (_super) {
    __extends(Selectbox, _super);
    function Selectbox(props) {
      const _this = _super.call(this, 'selectbox', {
        name: null,
        selectable: true,
        filterItems: null,
        multiple: false,
      ...
      if (!_this.getProp('name')) {
        const hiddenInput = _this.getElement().querySelector('input[type="hidden"]');
        if (hiddenInput) {
      ...
      _this.filterItemsHandler = function (event) {
        ...
        _this.getItems().forEach((item) => {
          const filterItems = _this.getProp('filterItems');
          const fn = typeof filterItems === 'function' ? filterItems : _this.filterItems;
          if (fn(search, item)) {
      ...
      const selectedItem = _this.getItemData(_this.getElement().querySelector('[data-selected]'));
      if (selectedItem) {
    ...
    Selectbox.prototype.getItems = function () {
      ...
      return items.map((item) => {
        const info = _this.getItemData(item);
    ...
    Selectbox.prototype.onElementEvent = function (event) {
      const { target } = event;
      if (event.type === utils.Event.START) {
        const selectbox = utils.Selector.closest(target, '.selectbox');
        ...
        const dismissButton = utils.Selector
          .closest(target, '[data-dismiss="selectbox"]');
        if (dismissButton) {
          this.hide();
          return;
        }
        const selectedTag = utils.Selector.closest(target, '.icon-close');
        if (selectedTag) {
          this.removeSelected(selectedTag.parentNode);
          return;
        }
        const item = utils.Selector.closest(target, '.selectbox-menu-item');
        ...
        const selectboxMenu = utils.Selector.closest(target, '.selectbox-menu');
        if (selectboxMenu) {
          return;
        }
        this.toggle();
    ...
    Selectbox.prototype.addItemSelection = function (value) {
      ...
      if ((!this.getProp('multiple') && !lastHiddenInput) || this.getProp('multiple')) {
        ...
        const name_1 = this.getProp('name');
    ...
    Selectbox.prototype.updateActiveList = function () {
      ...
      const items = Array
        .from(this.getElement().querySelectorAll('.selectbox-menu-item') || []);
      items.forEach((item) => {
        const data = _this.getItemData(item);
  ...
  const Tab = (function (_super) {
    __extends(Tab, _super);
    function Tab(props) {
      const _this = _super.call(this, 'tab', {}, props) || this;
    ...
    Tab.prototype.show = function (tabLink) {
      ...
      const tabItem = utils.Selector.closest(tabLink, `.${this.tabItemSelector}`);
      if (!tabItem || tabItem.classList.contains('active')) {
        return false;
      }
      const id = tabLink.getAttribute('href') || tabLink.getAttribute('data-target');
      if (!id) {
        return false;
      }
      ...
      const prevTabItem = tabContainer.querySelector('.tab-item.active');
  ...
  const componentCreator = function (component, options) {
    if (options === void 0) { options = {}; }
    return utils.Observer.getComponent(component, options) || new component(options);
  };
  const api = {
    accordion(options) { return componentCreator(Accordion, options); },
    alert(options) { return componentCreator(Alert, options); },
    modal(options) { return componentCreator(Modal, options); },
    modalConfirm(options) { return componentCreator(ModalConfirm, options); },
    modalLoader(options) { return componentCreator(ModalLoader, options); },
    modalPrompt(options) { return componentCreator(ModalPrompt, options); },
    loader(options) { return componentCreator(Loader, options); },
    collapse(options) { return componentCreator(Collapse, options); },
    notification(options) { return componentCreator(Notification, options); },
    offCanvas(options) { return componentCreator(OffCanvas, options); },
    tab(options) { return componentCreator(Tab, options); },
    selectbox(options) { return componentCreator(Selectbox, options); },
    progress(options) { return componentCreator(Progress, options); },
  };
  const phonon = Object.assign(api, utils);
